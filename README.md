...
Then install belanaetcher or any other flasher you know
Flash the ESD image to a storage drive separate from your UEFI flashed storage device(DO NOT USE A MICRO SD CARD USE GOOD HHD/SDD)
