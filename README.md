...
Then install Heslo WinToUSB on a windows vm/machine(Free version can be used, it only supports installing the home edition but we can switch to pro edition later after 
windows boots.)
