...
Then install rufus on a windows vm/machine
Flash the ESD image to a storage device u didnt use for uefi using rufus(DO NOT USE A MICRO SD CARD USE GOOD HHD/SDD)
...
Click the storage device that you flashed the esd image to its msotly 3rd.
